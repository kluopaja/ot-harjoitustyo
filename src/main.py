...
plane_factory_1 = PlaneFactory(project_root / "assets/plane.png", project_root / "assets/bullet.png")
plane_factory_1.start_position = Vector2(400, 400)
plane_factory_2 = PlaneFactory(project_root / "assets/plane.png", project_root / "assets/bullet.png")
plane_factory_2.start_position = Vector2(1000, 400)
player = Player(plane_factory_1, player_input, game_notification_1, Timer(1))
player2 = Player(plane_factory_2,  player_input2, game_notification_2, Timer(0.5))
